...
> delete_characters_character_id_mail_labels_label_id(ctx, character_id, label_id, optional)
Delete a mail label
...
> delete_characters_character_id_mail_mail_id(ctx, character_id, mail_id, optional)
Delete a mail
...
> Vec<::models::GetCharactersCharacterIdMail200Ok> get_characters_character_id_mail(ctx, character_id, optional)
Return mail headers
 ...
 **labels** | [**Vec&lt;i32&gt;**](i32.md)| Fetch only mails that match one or more of the given labels | 
 **last_mail_id** | **i32**| List only mail with an ID lower than the given ID, if present | 
 **token** | **String**| Access token to use if unable to set a header | 

### Return type

[**Vec<::models::GetCharactersCharacterIdMail200Ok>**](get_characters_character_id_mail_200_ok.md)
...
> ::models::GetCharactersCharacterIdMailLabelsOk get_characters_character_id_mail_labels(ctx, character_id, optional)
...
[**::models::GetCharactersCharacterIdMailLabelsOk**](get_characters_character_id_mail_labels_ok.md)
...
> Vec<::models::GetCharactersCharacterIdMailLists200Ok> get_characters_character_id_mail_lists(ctx, character_id, optional)
...
[**Vec<::models::GetCharactersCharacterIdMailLists200Ok>**](get_characters_character_id_mail_lists_200_ok.md)
...
> ::models::GetCharactersCharacterIdMailMailIdOk get_characters_character_id_mail_mail_id(ctx, character_id, mail_id, optional)
Return a mail
...
[**::models::GetCharactersCharacterIdMailMailIdOk**](get_characters_character_id_mail_mail_id_ok.md)
...
> i32 post_characters_character_id_mail(ctx, character_id, mail, optional)
Send a new mail
...
> i32 post_characters_character_id_mail_labels(ctx, character_id, label, optional)
Create a mail label
...
> put_characters_character_id_mail_mail_id(ctx, character_id, contents, mail_id, optional)
