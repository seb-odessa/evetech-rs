...
impl GetCharactersCharacterIdAssets200Ok {
  /// 200 ok object
  pub fn new(is_singleton: bool, item_id: i64, location_flag: String, location_id: i64, location_type: String, quantity: i32, type_id: i32) -> GetCharactersCharacterIdAssets200Ok {
  ...
  pub fn with_is_blueprint_copy(mut self, is_blueprint_copy: bool) -> GetCharactersCharacterIdAssets200Ok {
    self.is_blueprint_copy = Some(is_blueprint_copy);
    self
  }
  ...
  pub fn with_is_singleton(mut self, is_singleton: bool) -> GetCharactersCharacterIdAssets200Ok {
    self.is_singleton = is_singleton;
    self
  }
  ...
  pub fn with_item_id(mut self, item_id: i64) -> GetCharactersCharacterIdAssets200Ok {
    self.item_id = item_id;
    self
  }
  ...
  pub fn with_location_flag(mut self, location_flag: String) -> GetCharactersCharacterIdAssets200Ok {
    self.location_flag = location_flag;
    self
  }
  ...
  pub fn with_location_id(mut self, location_id: i64) -> GetCharactersCharacterIdAssets200Ok {
    self.location_id = location_id;
    self
  }
  ...
  pub fn with_location_type(mut self, location_type: String) -> GetCharactersCharacterIdAssets200Ok {
    self.location_type = location_type;
    self
  }
  ...
  pub fn with_quantity(mut self, quantity: i32) -> GetCharactersCharacterIdAssets200Ok {
    self.quantity = quantity;
    self
  }
  ...
  pub fn with_type_id(mut self, type_id: i32) -> GetCharactersCharacterIdAssets200Ok {
    self.type_id = type_id;
    self
  }
