...
impl GetUniversePlanetsPlanetIdPosition {
  ...
  pub fn with_x(mut self, x: f64) -> GetUniversePlanetsPlanetIdPosition {
    self.x = x;
    self
  }
  ...
  pub fn with_y(mut self, y: f64) -> GetUniversePlanetsPlanetIdPosition {
    self.y = y;
    self
  }
  ...
  pub fn with_z(mut self, z: f64) -> GetUniversePlanetsPlanetIdPosition {
    self.z = z;
    self
  }
