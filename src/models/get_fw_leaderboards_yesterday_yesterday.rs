...
impl GetFwLeaderboardsYesterdayYesterday {
  ...
  pub fn with_amount(mut self, amount: i32) -> GetFwLeaderboardsYesterdayYesterday {
    self.amount = Some(amount);
    self
  }
  ...
  pub fn with_faction_id(mut self, faction_id: i32) -> GetFwLeaderboardsYesterdayYesterday {
    self.faction_id = Some(faction_id);
    self
  }
