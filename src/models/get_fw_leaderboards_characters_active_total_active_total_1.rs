...
impl GetFwLeaderboardsCharactersActiveTotalActiveTotal1 {
  ...
  pub fn with_amount(mut self, amount: i32) -> GetFwLeaderboardsCharactersActiveTotalActiveTotal1 {
    self.amount = Some(amount);
    self
  }
  ...
  pub fn with_character_id(mut self, character_id: i32) -> GetFwLeaderboardsCharactersActiveTotalActiveTotal1 {
    self.character_id = Some(character_id);
    self
  }
