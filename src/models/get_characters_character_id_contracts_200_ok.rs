...
impl GetCharactersCharacterIdContracts200Ok {
  /// 200 ok object
  pub fn new(acceptor_id: i32, assignee_id: i32, availability: String, contract_id: i32, date_expired: String, date_issued: String, for_corporation: bool, issuer_corporation_id: i32, issuer_id: i32, status: String, _type: String) -> GetCharactersCharacterIdContracts200Ok {
  ...
  pub fn with_acceptor_id(mut self, acceptor_id: i32) -> GetCharactersCharacterIdContracts200Ok {
    self.acceptor_id = acceptor_id;
    self
  }
  ...
  pub fn with_assignee_id(mut self, assignee_id: i32) -> GetCharactersCharacterIdContracts200Ok {
    self.assignee_id = assignee_id;
    self
  }
  ...
  pub fn with_availability(mut self, availability: String) -> GetCharactersCharacterIdContracts200Ok {
    self.availability = availability;
    self
  }
  ...
  pub fn with_buyout(mut self, buyout: f64) -> GetCharactersCharacterIdContracts200Ok {
    self.buyout = Some(buyout);
    self
  }
  ...
  pub fn with_collateral(mut self, collateral: f64) -> GetCharactersCharacterIdContracts200Ok {
    self.collateral = Some(collateral);
    self
  }
  ...
  pub fn with_contract_id(mut self, contract_id: i32) -> GetCharactersCharacterIdContracts200Ok {
    self.contract_id = contract_id;
    self
  }
  ...
  pub fn with_date_accepted(mut self, date_accepted: String) -> GetCharactersCharacterIdContracts200Ok {
    self.date_accepted = Some(date_accepted);
    self
  }
  ...
  pub fn with_date_completed(mut self, date_completed: String) -> GetCharactersCharacterIdContracts200Ok {
    self.date_completed = Some(date_completed);
    self
  }
  ...
  pub fn with_date_expired(mut self, date_expired: String) -> GetCharactersCharacterIdContracts200Ok {
    self.date_expired = date_expired;
    self
  }
  ...
  pub fn with_date_issued(mut self, date_issued: String) -> GetCharactersCharacterIdContracts200Ok {
    self.date_issued = date_issued;
    self
  }
  ...
  pub fn with_days_to_complete(mut self, days_to_complete: i32) -> GetCharactersCharacterIdContracts200Ok {
    self.days_to_complete = Some(days_to_complete);
    self
  }
  ...
  pub fn with_end_location_id(mut self, end_location_id: i64) -> GetCharactersCharacterIdContracts200Ok {
    self.end_location_id = Some(end_location_id);
    self
  }
  ...
  pub fn with_for_corporation(mut self, for_corporation: bool) -> GetCharactersCharacterIdContracts200Ok {
    self.for_corporation = for_corporation;
    self
  }
  ...
  pub fn with_issuer_corporation_id(mut self, issuer_corporation_id: i32) -> GetCharactersCharacterIdContracts200Ok {
    self.issuer_corporation_id = issuer_corporation_id;
    self
  }
  ...
  pub fn with_issuer_id(mut self, issuer_id: i32) -> GetCharactersCharacterIdContracts200Ok {
    self.issuer_id = issuer_id;
    self
  }
  ...
  pub fn with_price(mut self, price: f64) -> GetCharactersCharacterIdContracts200Ok {
    self.price = Some(price);
    self
  }
  ...
  pub fn with_reward(mut self, reward: f64) -> GetCharactersCharacterIdContracts200Ok {
    self.reward = Some(reward);
    self
  }
  ...
  pub fn with_start_location_id(mut self, start_location_id: i64) -> GetCharactersCharacterIdContracts200Ok {
    self.start_location_id = Some(start_location_id);
    self
  }
  ...
  pub fn with_status(mut self, status: String) -> GetCharactersCharacterIdContracts200Ok {
    self.status = status;
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> GetCharactersCharacterIdContracts200Ok {
    self.title = Some(title);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> GetCharactersCharacterIdContracts200Ok {
    self._type = _type;
    self
  }
  ...
  pub fn with_volume(mut self, volume: f64) -> GetCharactersCharacterIdContracts200Ok {
    self.volume = Some(volume);
    self
  }
