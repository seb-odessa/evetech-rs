...
impl PostCharactersCharacterIdAssetsLocationsPosition {
  ...
  pub fn with_x(mut self, x: f64) -> PostCharactersCharacterIdAssetsLocationsPosition {
    self.x = x;
    self
  }
  ...
  pub fn with_y(mut self, y: f64) -> PostCharactersCharacterIdAssetsLocationsPosition {
    self.y = y;
    self
  }
