...
impl GetCharactersCharacterIdBlueprints200Ok {
  /// 200 ok object
  pub fn new(item_id: i64, location_flag: String, location_id: i64, material_efficiency: i32, quantity: i32, runs: i32, time_efficiency: i32, type_id: i32) -> GetCharactersCharacterIdBlueprints200Ok {
  ...
  pub fn with_item_id(mut self, item_id: i64) -> GetCharactersCharacterIdBlueprints200Ok {
    self.item_id = item_id;
    self
  }
  ...
  pub fn with_location_flag(mut self, location_flag: String) -> GetCharactersCharacterIdBlueprints200Ok {
    self.location_flag = location_flag;
    self
  }
  ...
  pub fn with_location_id(mut self, location_id: i64) -> GetCharactersCharacterIdBlueprints200Ok {
    self.location_id = location_id;
    self
  }
  ...
  pub fn with_material_efficiency(mut self, material_efficiency: i32) -> GetCharactersCharacterIdBlueprints200Ok {
    self.material_efficiency = material_efficiency;
    self
  }
  ...
  pub fn with_quantity(mut self, quantity: i32) -> GetCharactersCharacterIdBlueprints200Ok {
    self.quantity = quantity;
    self
  }
  ...
  pub fn with_runs(mut self, runs: i32) -> GetCharactersCharacterIdBlueprints200Ok {
    self.runs = runs;
    self
  }
  ...
  pub fn with_time_efficiency(mut self, time_efficiency: i32) -> GetCharactersCharacterIdBlueprints200Ok {
    self.time_efficiency = time_efficiency;
    self
  }
  ...
  pub fn with_type_id(mut self, type_id: i32) -> GetCharactersCharacterIdBlueprints200Ok {
    self.type_id = type_id;
    self
  }
