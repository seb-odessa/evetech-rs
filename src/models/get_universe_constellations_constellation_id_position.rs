...
impl GetUniverseConstellationsConstellationIdPosition {
  ...
  pub fn with_x(mut self, x: f64) -> GetUniverseConstellationsConstellationIdPosition {
    self.x = x;
    self
  }
  ...
  pub fn with_y(mut self, y: f64) -> GetUniverseConstellationsConstellationIdPosition {
    self.y = y;
    self
  }
  ...
  pub fn with_z(mut self, z: f64) -> GetUniverseConstellationsConstellationIdPosition {
    self.z = z;
    self
  }
