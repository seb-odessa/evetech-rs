...
impl GetCharactersCharacterIdKillmailsRecent200Ok {
  ...
  pub fn with_killmail_hash(mut self, killmail_hash: String) -> GetCharactersCharacterIdKillmailsRecent200Ok {
    self.killmail_hash = killmail_hash;
    self
  }
  ...
  pub fn with_killmail_id(mut self, killmail_id: i32) -> GetCharactersCharacterIdKillmailsRecent200Ok {
    self.killmail_id = killmail_id;
    self
  }
